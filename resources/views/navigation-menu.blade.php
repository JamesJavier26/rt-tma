            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <script>
                    document.addEventListener('livewire:load', function () {
                        Livewire.on('notificationsLoaded', notifications => {
                            // Update your notifications array or UI here
                            console.log(notifications); // Example: Log notifications to console
                        });
                    });
                </script>

@if(isset($showNotifications) && $showNotifications)
    <div class="absolute right-0 mt-2 bg-white border border-gray-300 p-2 rounded shadow-lg">
        @foreach($notifications as $notification)
            {{ $notification->data['task_name'] }}: {{ $notification->data['comment'] }}
